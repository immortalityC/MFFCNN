...
#      --nl_num 1\
#      --use_norm 1\
#      --itr 1 --batch_size 32 --learning_rate  0.002 >logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
#done
##
#
#for pred_len in 192
...
do
    python -u run_longExp.py \
      ...
      --nl_num 1\
      --use_norm 1\
      --itr 1 --batch_size 8 --learning_rate  0.0015 >logs/LongForecasting/$model_name'_'$model_id_name'_'$seq_len'_'$pred_len.log
done
